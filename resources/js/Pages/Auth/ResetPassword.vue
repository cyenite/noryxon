    ...
    <GuestLayout>
        ...
        <div class="mb-8">
            <div class="flex items-center gap-2 mb-3">
                ...
                <span class="font-mono text-[10px] text-pulse tracking-widest uppercase">PASSWORD_RESET</span>
            </div>
            <h2 class="text-2xl font-black tracking-tight text-text-primary">Choose a new password</h2>
            <p class="mt-1 text-sm text-text-muted">Make it strong. Your invoices are counting on you.</p>
        </div>
